...
# todo: experiment with different vectorstores
...
loader = TelegramChatLoader("/home/qazybek/NVME/repos/mlops/qa_llm/data/raw/chat_history.json")
...
class MessageSearch:
    def __init__(self, chat_history_path: Path, embedder_name: str):
        pass